...
$current = Invoke-Command -ComputerName $targets -Credential $creds .\processes.ps1

$lfaprocesses = $current | Sort-Object -Property pscomputername, hash -Unique |
    Group-Object hash | Where-Object {$_.count -le 2} | Select-Object -ExpandProperty Group
