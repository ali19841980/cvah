...
$current = Invoke-Command -ComputerName $targets -Credential $creds .\scheduledtask.ps1

$lfascheduledtasks == $current | Sort-Object -Property pscomputername, taskname -Unique |
    Group-Object taskname | Where-Object {$_.count -le 2} | Select-Object -ExpandProperty Group